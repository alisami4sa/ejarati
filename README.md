...
## تذكير الإيجار التلقائي

كل يوم الساعة **8:00 صباحاً بتوقيت السعودية** يفحص النظام الدفعات غير المدفوعة التي تستحق بعد **10 أيام** بالضبط، ويرسل إيميل تلقائي عبر Resend لبريد المالك — بدون زر أو إعدادات.
...
(يُستخدم لحماية مسار `/api/cron/rent-reminders`)
